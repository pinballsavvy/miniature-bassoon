...
while(1){
  while(CenableDrivePID){
    ...
    //--------------------------------------------------end
    if(error < 2 ){
      CATA.spin(forward, 0, voltageUnits::volt);
      CATA2.spin(forward, 0, voltageUnits::volt);
    }else{
      CATA.spin(forward, lateralMotorPower, voltageUnits::volt);
      CATA2.spin(reverse, lateralMotorPower, voltageUnits::volt);
    }
...
void usercontrol(void) {
  ...
  //////////////////////////////////////////////////
      ...
      */
      ...
      {
        //if go spin
        if(CenableDrivePID == false){
        CATA2.spin(vex::directionType::rev, 100, vex::velocityUnits::pct);
      ...
      else if(Controller1.ButtonL2.pressing())
      {
        //if go spin other
        if(CenableDrivePID ==false){
        CATA2.spin(vex::directionType::fwd, 100, vex::velocityUnits::pct);
        ...
        //if not go dont go
        if(CenableDrivePID == false){
        CATA2.spin(vex::directionType::fwd, 0, vex::velocityUnits::pct);
        CATA.spin(vex::directionType::fwd, 0, vex::velocityUnits::pct);
        }
